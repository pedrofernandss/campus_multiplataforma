...
const ModalComponent: React.FC<ModalBox> = ({
  title,
  label,
  icon,
  isOpen,
  ...
  return (
    ...
    >
      <View style={styles.overlay}>
        <View
          style={[
            icon ? styles.modalContainer : styles.modalContainerWithoutIcon,
          ]}
        >
          {icon && (
            <Image
          ...
          <View style={styles.buttonContainer}>
            ...
            {onConfirmButton && (
              <TouchableOpacity
                style={[
                  !onCancelButton ? styles.onlyConfirmButton : styles.button,
                ]}
